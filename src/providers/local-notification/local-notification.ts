...
export class LocalNotificationProvider {
    ...
    async create(content_: any) {
        ...
        if (this.platform.is('android')) {
            const drawableIcon = (content_.group === 'recordatorio') ? 'hoy' : 'medico';
            // contentSchedule.group = content_.group;
            // contentSchedule.led = 'FF0000';
            contentSchedule.icon = 'res://drawable/' + drawableIcon + '.png';
            // contentSchedule.smallIcon = 'res://mipmap-hdpi/ic_launcher.png';
    ...
    setSound() {
        if (this.platform.is('android')) {
            ...
            return 'res://assets/sounds/alerta.mp3'
        }
    }
